...
namespace SGBankTest
{
    ...
    public class BasicAccountTests
    {
        ...
        [TestCase("33333", "Basic Account", 100, AccountType.Free, -100, 100, false)]     //not a basic account
        [TestCase("33333", "Basic Account", 100, AccountType.Basic, 100, 100, false)]     //positive withdraw attempt  
        [TestCase("33333", "Basic Account", 150, AccountType.Basic, -50, 100, true)]      //success without an overdraft fee
        [TestCase("33333", "Basic Account", 100, AccountType.Basic, -150, -60, true)]     //success with OD fee (-60 = balance(100) - (withdrawal)150 - (OD Fee)10
