...
begin
	...
	set identity_insert Vehicle on;
		...
		insert into Vehicle (VehicleId, MakeId, Model, TypeId, BodyStyleId, [Year], TransmissionId, ColorId, InteriorId, Mileage, VIN, MSRP, SalePrice, [Description], PictureFilePath, IsFeature)
		values (1, 1, 'Cabriolet', 2, 1, '1988', 2, 3, 2, 3333, 987654321, 5000, 3500, 'super cute', 'SmallerCabbyPic.jpg', 1),
			(2,1,'Thing',2,1,'1976',2,4,4,5500,123456789,8000,7500,'a hideous classic sure to turn heads', 'SmallerThing.jpg', 1),
			(3,2,'F-150',1,5,'1995',1,2,2,0,123123123,12000,11800,'a classic that has never left the showroom floor. 4x4 is great for winter driving.','SmallerF150pic.jpg',0),
			(4,4,'Typhoon',2,4,'1996',1,2,4,30000,111222333444,8000,6500,'this thing is fast but dont make any sharp turns, it will roll','SmallerTyphoon.jpg',1),
			(5,3,'Prizm',2,3,'1996',2,2,2,150000,998877665544,2500,800,'great option for low-income people','prizmPic2.jpg',1),
			(6,1,'Thing',2,1,'1974',2,4,4,500,223456789,10000,9500,'a hideous classic sure to turn heads', 'SmallerThing.jpg', 1)
